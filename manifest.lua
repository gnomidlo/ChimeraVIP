return {
    ...
    changes = {
        "Sprzet: KP rozbite na klute, ciete i obuchowe",
        "Sprzet: ochrona lokacji pokazana w trzech zwartych wierszach",
        "Sprzet: osobne kolory typow obrazen dla szybszego porownania",
    },
    files = {
        "loader.lua",
        "src/init.lua",
    ...
    file_meta = {
        ...
        ["src/core/bootstrap.lua"] = {hash="32c6ca9f5c906ae58d94120ec2a5df9399b3af35", size=1479},
        ...
        ["src/features/weapon_info.lua"] = {hash="ed0150622ebf7e3182d4f9e77de35814155a53fa", size=14126},
