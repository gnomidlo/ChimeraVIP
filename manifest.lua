return {
    ...
    changes = {
        "Core: dalsze porzadki wspolnych helperow przed 1.0",
        "Footer: cache niezmienionych danych GMCP vitals",
        "Zgodnosc: potwierdzony upstream Chimery 4.3",
        "Porzadki: usuniete stare lokalne migracje i odswiezona dokumentacja",
    },
    files = {
        "loader.lua",
        "src/init.lua",
    ...
    file_meta = {
        ...
        ["src/core/bootstrap.lua"] = {hash="4227225649a66303cd9aff6e31d00e01990961bb", size=1479},
