return {
    ...
    changes = {
        "Kondycje: nowy widok taktyczny oparty bezposrednio na GMCP",
        "Kondycje: stale znaczniki druzyny, wrogow i innych postaci oraz paski HP",
        "Kondycje: relacje walki sa pokazywane jako znaczniki ->[] i <-[] po nazwie",
        "Kondycje: lider druzyny jest oznaczony gwiazdka przed paskiem HP",
    },
    files = {
        "loader.lua",
        "src/init.lua",
    ...
    file_meta = {
        ...
        ["src/init.lua"] = {hash="fb705fc1dc7917581443f6271e2b4929143b275e", size=2099},
        ["src/core/bootstrap.lua"] = {hash="90f8e0ca6e71235a704e2a564ffc9b5b92052b5b", size=1471},
