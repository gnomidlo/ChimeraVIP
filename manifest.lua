return {
    ...
    changes = {
        "Sprzet: magia przeniesiona do naglowka oceny",
        "Sprzet: magiczny przedmiot ma lawendowy naglowek z nazwa",
        "Sprzet: zwykle karty pozostaja bez dodatkowej linii MAGIA",
    },
    files = {
        "loader.lua",
        "src/init.lua",
    ...
    file_meta = {
        ...
        ["src/core/bootstrap.lua"] = {hash="c019c9e7ec6f23e402601f4a19377a27ef4c9b98", size=1479},
