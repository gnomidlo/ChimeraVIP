...
-- Sesja przezywa hot reload, ale nie restart Mudleta.
XP.session = XP.session or {
    started_at=nil, last_kill_at=nil, active_seconds=0,
    total_xp=0, kills=0, own_kills=0, group_kills=0,
    own_xp=0, group_xp=0, events={},
}
...
function XP:add_event(raw_mob, amount, killer, own)
    ...
    S.events[#S.events + 1] = {
        time=now, xp=amount, mob_raw=trim(raw_mob), mob=mob,
        classification=classification, killer=killer, own=own == true,
    }
...
function XP:get_mob_stats()
    ...
    for _, event in ipairs(self.session.events) do
        ...
        stats[key] = stats[key] or {
            name=key, xp=0, kills=0, builtin=event.classification == "rule",
...
function XP:show_last(count)
    ...
    for i = first, #events do
        ...
        local marker = event.classification == "rule" and "*" or " "
...
function XP:show_help()
    ...
    hecho("\n\n" .. Cc.lavender .. "XP — POMOC\n" .. Cc.separator .. "--------------------------------------------------"
        ...
        .. "\n\n" .. Cc.text .. "/xp" .. Cc.text_muted .. "                 podsumowanie sesji"
        .. "\n" .. Cc.text .. "/xp mobs" .. Cc.text_muted .. "            statystyki typów mobów"
        .. "\n" .. Cc.text .. "/xp mob " .. Cc.mint .. "nazwa" .. Cc.text_muted .. "        szczegóły typu"
        .. "\n" .. Cc.text .. "/xp last [N]" .. Cc.text_muted .. "        ostatnie N zabójstw"
        .. "\n" .. Cc.text .. "/xp reset" .. Cc.text_muted .. "           wyzeruj sesję"
        .. "\n" .. Cc.text .. "/xp pomoc" .. Cc.text_muted .. "           ta pomoc")
end
