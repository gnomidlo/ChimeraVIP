...
R.word_amounts = {
    ...
    piec=5, piecioro=5,
    szesc=6, szescioro=6,
    siedem=7, siedmioro=7,
    osiem=8, osmioro=8,
    dziewiec=9, dziewiecioro=9,
    dziesiec=10, dziesiecioro=10,
    jedenascie=11, jedenascioro=11,
    dwanascie=12, dwanascioro=12,
    trzynascie=13, trzynascioro=13,
    czternascie=14, czternascioro=14,
    pietnascie=15, pietnascioro=15,
    szesnascie=16, szesnascioro=16,
    siedemnascie=17, siedemnascioro=17,
    osiemnascie=18, osiemnascioro=18,
    dziewietnascie=19, dziewietnascioro=19,
    dwadziescia=20, dwadziescioro=20,
}
